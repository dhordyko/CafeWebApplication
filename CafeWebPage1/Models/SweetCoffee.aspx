<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SweetCoffee.aspx.cs" Inherits="CafeWebPage1.Models.SweetCoffee" %>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="../Images/SweetCoffee/Slides/article-beverage-break-1329064.jpg" alt="Chania" width="460" height="345">
      ...
      <div class="item">
        <img src="../Images/SweetCoffee/Slides/beverage-breakfast-close-up-266642.jpg" alt="Chania" width="460" height="345">
        <div class="carousel-caption">
          <h3>Our Cafe</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit </p>
        </div>
      ...
      <div class="item">
        <img  src="../Images/SweetCoffee/Slides/blur-cappuccino-chocolate-230588.jpg" alt="Chania" width="460" height="345">
        <div class="carousel-caption">
          <h3>Our Cafe</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit </p>
        </div>
      ...
      <div class="item">
        <img src="../Images/SweetCoffee/Slides/lovely-and-romantic-heart-coffee-cups-picjumbo-com.jpg" alt="Chania" width="460" height="345"> 
        <div class="carousel-caption">
          <h3>Our Cafe</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit </p>
        </div>
        ...
        <div class='container-fluid sweet-coffee'>
            <div class='row offer-items'>
            
       <asp:Label ID="outputSweetCoffee" runat="server" Text="Label"></asp:Label> 
