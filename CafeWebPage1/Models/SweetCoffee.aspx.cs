...
{
    public partial class SweetCoffee : System.Web.UI.Page
    {
        ...
        {
            ArrayList coffeeList = ConnectionClass.GetCoffeeByType("Sweet coffee");
            ...
            ", coffee.Name, coffee.Type, coffee.Price, coffee.Roast, coffee.Country, coffee.Review, coffee.Image));
                outputSweetCoffee.Text = sb.ToString();
            }
